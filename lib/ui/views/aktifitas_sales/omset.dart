...
class OmsetView extends ConsumerStatefulWidget {
  const OmsetView({super.key});

  @override
  ConsumerState<OmsetView> createState() => _OmsetViewState();
}

class _OmsetViewState extends ConsumerState<OmsetView> {
  @override
