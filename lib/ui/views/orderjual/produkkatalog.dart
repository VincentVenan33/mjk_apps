...
class ProdukKatalogView extends ConsumerStatefulWidget {
  const ProdukKatalogView({Key? key}) : super(key: key);

  @override
  ConsumerState<ProdukKatalogView> createState() => _ProdukKatalogViewState();
}

class _ProdukKatalogViewState extends ConsumerState<ProdukKatalogView> {
  ...
  void _navigateToDetailPage() {
    Navigator.of(context).push(MaterialPageRoute(
      builder: (context) => const AddDetailOrderJual(),
    ));
