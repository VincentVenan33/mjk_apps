...
import '../../../core/view_models/produk/produk_view_model.dart';
...
class _KatalogProdukViewState extends ConsumerState<KatalogProdukView> {
  ...
  Widget build(BuildContext context) {
    return ViewModel<ProdukViewModel>(
      model: ProdukViewModel(
        produkApi: ref.read(produkApi),
      ),
      onModelReady: (ProdukViewModel model) => model.initModel(),
      builder: (_, ProdukViewModel model, __) {
